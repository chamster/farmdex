...
class OriginsControllerTest < ActionController::TestCase
  ...
  test "should create origin" do
    assert_difference('Origin.count') do
      post :create, origin: { flock_name: @origin.flock_name, origin: @origin.origin, sort_order: @origin.sort_order }
    end
  ...
  test "should update origin" do
    patch :update, id: @origin, origin: { flock_name: @origin.flock_name, origin: @origin.origin, sort_order: @origin.sort_order }
    assert_redirected_to origin_path(assigns(:origin))
  end
